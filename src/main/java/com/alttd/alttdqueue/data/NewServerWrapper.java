...
public class NewServerWrapper {
    ...
    public NewServerWrapper(RegisteredServer registeredServer, ServerConfig serverConfig, AlttdQueue plugin) {
    ...
    public synchronized void removeOnlinePlayerDueToError(UUID uuid) {
    ...
    private synchronized void updateOnlinePlayers() {
        onlinePlayers.clear();
